...
export const closeUserSessions = (id, reason) => req('POST', `/users/${id}/sessions/close-all`, { reason })
export const closeUserOtherSessions = (id, reason) => req('POST', `/users/${id}/sessions/close-others`, { reason })
